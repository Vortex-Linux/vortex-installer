...
struct qt_meta_stringdata_CLASSCalamaresSCOPEDebugWindowENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSCalamaresSCOPEDebugWindowENDCLASS = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_CLASSCalamaresSCOPEDebugWindowENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject Calamares::DebugWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSCalamaresSCOPEDebugWindowENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSCalamaresSCOPEDebugWindowENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSCalamaresSCOPEDebugWindowENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void Calamares::DebugWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &DebugWindow::closed; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *Calamares::DebugWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSCalamaresSCOPEDebugWindowENDCLASS.stringdata0))
...
#ifdef QT_MOC_HAS_STRINGDATA
struct qt_meta_stringdata_CLASSCalamaresSCOPEDebugWindowManagerENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSCalamaresSCOPEDebugWindowManagerENDCLASS = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_CLASSCalamaresSCOPEDebugWindowManagerENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject Calamares::DebugWindowManager::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSCalamaresSCOPEDebugWindowManagerENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSCalamaresSCOPEDebugWindowManagerENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSCalamaresSCOPEDebugWindowManagerENDCLASS_t,
        // property 'enabled'
...
void Calamares::DebugWindowManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &DebugWindowManager::visibleChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_CLASSCalamaresSCOPEDebugWindowManagerENDCLASS.stringdata0))
        return static_cast<void*>(this);
