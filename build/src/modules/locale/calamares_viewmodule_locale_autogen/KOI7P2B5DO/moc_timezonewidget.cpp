...
struct qt_meta_stringdata_CLASSTimeZoneWidgetENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSTimeZoneWidgetENDCLASS = QtMocHelpers::stringData(
    "TimeZoneWidget",
    "locationChanged",
    "",
    "const TimeZoneData*",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSTimeZoneWidgetENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject TimeZoneWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSTimeZoneWidgetENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSTimeZoneWidgetENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSTimeZoneWidgetENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<TimeZoneWidget, std::true_type>,
...
void TimeZoneWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &TimeZoneWidget::locationChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *TimeZoneWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSTimeZoneWidgetENDCLASS.stringdata0))
