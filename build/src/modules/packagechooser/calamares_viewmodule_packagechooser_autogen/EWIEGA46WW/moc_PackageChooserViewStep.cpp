...
struct qt_meta_stringdata_CLASSPackageChooserViewStepENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSPackageChooserViewStepENDCLASS = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_CLASSPackageChooserViewStepENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject PackageChooserViewStep::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSPackageChooserViewStepENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSPackageChooserViewStepENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSPackageChooserViewStepENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<PackageChooserViewStep, std::true_type>
    >,
    nullptr
} };
...
void *PackageChooserViewStep::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSPackageChooserViewStepENDCLASS.stringdata0))
...
#ifdef QT_MOC_HAS_STRINGDATA
struct qt_meta_stringdata_CLASSPackageChooserViewStepFactoryENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSPackageChooserViewStepFactoryENDCLASS = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_CLASSPackageChooserViewStepFactoryENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject PackageChooserViewStepFactory::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSPackageChooserViewStepFactoryENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSPackageChooserViewStepFactoryENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSPackageChooserViewStepFactoryENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<PackageChooserViewStepFactory, std::true_type>
    >,
    nullptr
} };
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_CLASSPackageChooserViewStepFactoryENDCLASS.stringdata0))
        return static_cast<void*>(this);
