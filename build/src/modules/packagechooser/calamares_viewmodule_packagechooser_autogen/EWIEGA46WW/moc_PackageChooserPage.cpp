...
struct qt_meta_stringdata_CLASSPackageChooserPageENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSPackageChooserPageENDCLASS = QtMocHelpers::stringData(
    "PackageChooserPage",
    "selectionChanged",
    "",
    "currentChanged",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSPackageChooserPageENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject PackageChooserPage::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSPackageChooserPageENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSPackageChooserPageENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSPackageChooserPageENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void PackageChooserPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &PackageChooserPage::selectionChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *PackageChooserPage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSPackageChooserPageENDCLASS.stringdata0))
