...
struct qt_meta_stringdata_CLASSLoaderQueueENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSLoaderQueueENDCLASS = QtMocHelpers::stringData(
    "LoaderQueue",
    "done",
    "",
    "load",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSLoaderQueueENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject LoaderQueue::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSLoaderQueueENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSLoaderQueueENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSLoaderQueueENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void LoaderQueue::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &LoaderQueue::done; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *LoaderQueue::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSLoaderQueueENDCLASS.stringdata0))
