...
struct qt_meta_stringdata_CLASSNetInstallViewStepENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSNetInstallViewStepENDCLASS = QtMocHelpers::stringData(
    "NetInstallViewStep",
    "nextIsReady",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSNetInstallViewStepENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject NetInstallViewStep::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSNetInstallViewStepENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSNetInstallViewStepENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSNetInstallViewStepENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<NetInstallViewStep, std::true_type>,
        // method 'nextIsReady'
...
void *NetInstallViewStep::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSNetInstallViewStepENDCLASS.stringdata0))
...
#ifdef QT_MOC_HAS_STRINGDATA
struct qt_meta_stringdata_CLASSNetInstallViewStepFactoryENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSNetInstallViewStepFactoryENDCLASS = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_CLASSNetInstallViewStepFactoryENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject NetInstallViewStepFactory::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSNetInstallViewStepFactoryENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSNetInstallViewStepFactoryENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSNetInstallViewStepFactoryENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<NetInstallViewStepFactory, std::true_type>
    >,
    nullptr
} };
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_CLASSNetInstallViewStepFactoryENDCLASS.stringdata0))
        return static_cast<void*>(this);
