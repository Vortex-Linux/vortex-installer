...
struct qt_meta_stringdata_CLASSInitramfsJobENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSInitramfsJobENDCLASS = QtMocHelpers::stringData(
    "InitramfsJob"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSInitramfsJobENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject InitramfsJob::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSInitramfsJobENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSInitramfsJobENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSInitramfsJobENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *InitramfsJob::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSInitramfsJobENDCLASS.stringdata0))
...
#ifdef QT_MOC_HAS_STRINGDATA
struct qt_meta_stringdata_CLASSInitramfsJobFactoryENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSInitramfsJobFactoryENDCLASS = QtMocHelpers::stringData(
    "InitramfsJobFactory"
);
#else  // !QT_MOC_HAS_STRINGDATA
#error "qtmochelpers.h not found or too old."
...
Q_CONSTINIT static const uint qt_meta_data_CLASSInitramfsJobFactoryENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject InitramfsJobFactory::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSInitramfsJobFactoryENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSInitramfsJobFactoryENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSInitramfsJobFactoryENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_CLASSInitramfsJobFactoryENDCLASS.stringdata0))
        return static_cast<void*>(this);
