...
struct qt_meta_stringdata_CLASSFinishedQmlViewStepENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSFinishedQmlViewStepENDCLASS = QtMocHelpers::stringData(
    "FinishedQmlViewStep"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSFinishedQmlViewStepENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject FinishedQmlViewStep::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSFinishedQmlViewStepENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSFinishedQmlViewStepENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSFinishedQmlViewStepENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *FinishedQmlViewStep::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSFinishedQmlViewStepENDCLASS.stringdata0))
...
#ifdef QT_MOC_HAS_STRINGDATA
struct qt_meta_stringdata_CLASSFinishedQmlViewStepFactoryENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSFinishedQmlViewStepFactoryENDCLASS = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_CLASSFinishedQmlViewStepFactoryENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject FinishedQmlViewStepFactory::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSFinishedQmlViewStepFactoryENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSFinishedQmlViewStepFactoryENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSFinishedQmlViewStepFactoryENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_CLASSFinishedQmlViewStepFactoryENDCLASS.stringdata0))
        return static_cast<void*>(this);
