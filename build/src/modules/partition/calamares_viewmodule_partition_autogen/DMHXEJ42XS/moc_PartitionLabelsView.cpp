...
struct qt_meta_stringdata_CLASSPartitionLabelsViewENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSPartitionLabelsViewENDCLASS = QtMocHelpers::stringData(
    "PartitionLabelsView",
    "updateGeometries",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSPartitionLabelsViewENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject PartitionLabelsView::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSPartitionLabelsViewENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSPartitionLabelsViewENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSPartitionLabelsViewENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *PartitionLabelsView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSPartitionLabelsViewENDCLASS.stringdata0))
