...
struct qt_meta_stringdata_CLASSResizeVolumeGroupDialogENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSResizeVolumeGroupDialogENDCLASS = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_CLASSResizeVolumeGroupDialogENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject ResizeVolumeGroupDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSResizeVolumeGroupDialogENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSResizeVolumeGroupDialogENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSResizeVolumeGroupDialogENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<ResizeVolumeGroupDialog, std::true_type>
    >,
    nullptr
} };
...
void *ResizeVolumeGroupDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSResizeVolumeGroupDialogENDCLASS.stringdata0))
