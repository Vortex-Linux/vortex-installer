...
struct qt_meta_stringdata_CLASSPartitionSplitterWidgetENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSPartitionSplitterWidgetENDCLASS = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_CLASSPartitionSplitterWidgetENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject PartitionSplitterWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSPartitionSplitterWidgetENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSPartitionSplitterWidgetENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSPartitionSplitterWidgetENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void PartitionSplitterWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &PartitionSplitterWidget::partitionResized; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *PartitionSplitterWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSPartitionSplitterWidgetENDCLASS.stringdata0))
