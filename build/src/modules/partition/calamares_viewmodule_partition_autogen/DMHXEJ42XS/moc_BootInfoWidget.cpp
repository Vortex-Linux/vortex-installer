...
struct qt_meta_stringdata_CLASSBootInfoWidgetENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSBootInfoWidgetENDCLASS = QtMocHelpers::stringData(
    "BootInfoWidget",
    "retranslateUi",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSBootInfoWidgetENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject BootInfoWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSBootInfoWidgetENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSBootInfoWidgetENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSBootInfoWidgetENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<BootInfoWidget, std::true_type>,
...
void *BootInfoWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSBootInfoWidgetENDCLASS.stringdata0))
