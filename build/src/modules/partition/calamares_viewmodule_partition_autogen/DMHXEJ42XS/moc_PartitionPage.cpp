...
struct qt_meta_stringdata_CLASSPartitionPageENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSPartitionPageENDCLASS = QtMocHelpers::stringData(
    "PartitionPage",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSPartitionPageENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject PartitionPage::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSPartitionPageENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSPartitionPageENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSPartitionPageENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *PartitionPage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSPartitionPageENDCLASS.stringdata0))
