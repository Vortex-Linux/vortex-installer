...
struct qt_meta_stringdata_CLASSPartitionBarsViewENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSPartitionBarsViewENDCLASS = QtMocHelpers::stringData(
    "PartitionBarsView",
    "updateGeometries",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSPartitionBarsViewENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject PartitionBarsView::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSPartitionBarsViewENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSPartitionBarsViewENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSPartitionBarsViewENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<PartitionBarsView, std::true_type>,
...
void *PartitionBarsView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSPartitionBarsViewENDCLASS.stringdata0))
