...
struct qt_meta_stringdata_CLASSChoicePageENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSChoicePageENDCLASS = QtMocHelpers::stringData(
    "ChoicePage",
    "nextStatusChanged",
    "",
    "actionChosen",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSChoicePageENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject ChoicePage::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSChoicePageENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSChoicePageENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSChoicePageENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void ChoicePage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &ChoicePage::nextStatusChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &ChoicePage::actionChosen; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (ChoicePage::*)();
            if (_t _q_method = &ChoicePage::deviceChosen; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
void *ChoicePage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSChoicePageENDCLASS.stringdata0))
