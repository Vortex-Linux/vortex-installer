...
struct qt_meta_stringdata_CLASSPartitionCoreModuleENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSPartitionCoreModuleENDCLASS = QtMocHelpers::stringData(
    "PartitionCoreModule",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSPartitionCoreModuleENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject PartitionCoreModule::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSPartitionCoreModuleENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSPartitionCoreModuleENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSPartitionCoreModuleENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void PartitionCoreModule::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &PartitionCoreModule::hasRootMountPointChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (PartitionCoreModule::*)(bool );
            if (_t _q_method = &PartitionCoreModule::isDirtyChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &PartitionCoreModule::reverted; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &PartitionCoreModule::deviceReverted; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }
...
void *PartitionCoreModule::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSPartitionCoreModuleENDCLASS.stringdata0))
