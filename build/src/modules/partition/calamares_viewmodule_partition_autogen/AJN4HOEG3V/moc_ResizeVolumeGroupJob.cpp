...
struct qt_meta_stringdata_CLASSResizeVolumeGroupJobENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSResizeVolumeGroupJobENDCLASS = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_CLASSResizeVolumeGroupJobENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject ResizeVolumeGroupJob::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSResizeVolumeGroupJobENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSResizeVolumeGroupJobENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSResizeVolumeGroupJobENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<ResizeVolumeGroupJob, std::true_type>
    >,
    nullptr
} };
...
void *ResizeVolumeGroupJob::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSResizeVolumeGroupJobENDCLASS.stringdata0))
