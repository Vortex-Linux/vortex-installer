...
struct qt_meta_stringdata_CLASSFormatPartitionJobENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSFormatPartitionJobENDCLASS = QtMocHelpers::stringData(
    "FormatPartitionJob"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSFormatPartitionJobENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject FormatPartitionJob::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSFormatPartitionJobENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSFormatPartitionJobENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSFormatPartitionJobENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<FormatPartitionJob, std::true_type>
    >,
    nullptr
} };
...
void *FormatPartitionJob::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSFormatPartitionJobENDCLASS.stringdata0))
