...
struct qt_meta_stringdata_CLASSSetPartFlagsJobENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSSetPartFlagsJobENDCLASS = QtMocHelpers::stringData(
    "SetPartFlagsJob"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSSetPartFlagsJobENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject SetPartFlagsJob::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSSetPartFlagsJobENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSSetPartFlagsJobENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSSetPartFlagsJobENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<SetPartFlagsJob, std::true_type>
    >,
    nullptr
} };
...
void *SetPartFlagsJob::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSSetPartFlagsJobENDCLASS.stringdata0))
