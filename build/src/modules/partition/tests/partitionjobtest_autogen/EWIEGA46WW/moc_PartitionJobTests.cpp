...
struct qt_meta_stringdata_CLASSPartitionJobTestsENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSPartitionJobTestsENDCLASS = QtMocHelpers::stringData(
    "PartitionJobTests",
    "initTestCase",
    "",
    "cleanupTestCase",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSPartitionJobTestsENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject PartitionJobTests::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSPartitionJobTestsENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSPartitionJobTestsENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSPartitionJobTestsENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *PartitionJobTests::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSPartitionJobTestsENDCLASS.stringdata0))
