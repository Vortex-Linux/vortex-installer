...
struct qt_meta_stringdata_CLASSPartitionJobENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSPartitionJobENDCLASS = QtMocHelpers::stringData(
    "PartitionJob",
    "iprogress",
    "",
    "percent"
...
Q_CONSTINIT static const uint qt_meta_data_CLASSPartitionJobENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject PartitionJob::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSPartitionJobENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSPartitionJobENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSPartitionJobENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<PartitionJob, std::true_type>,
        // method 'iprogress'
...
void *PartitionJob::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSPartitionJobENDCLASS.stringdata0))
