...
struct qt_meta_stringdata_CLASSClearMountsJobENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSClearMountsJobENDCLASS = QtMocHelpers::stringData(
    "ClearMountsJob"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSClearMountsJobENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject ClearMountsJob::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSClearMountsJobENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSClearMountsJobENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSClearMountsJobENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<ClearMountsJob, std::true_type>
    >,
    nullptr
} };
...
void *ClearMountsJob::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSClearMountsJobENDCLASS.stringdata0))
