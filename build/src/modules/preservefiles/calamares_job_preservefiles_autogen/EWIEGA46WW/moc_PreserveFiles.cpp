...
struct qt_meta_stringdata_CLASSPreserveFilesENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSPreserveFilesENDCLASS = QtMocHelpers::stringData(
    "PreserveFiles"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSPreserveFilesENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject PreserveFiles::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSPreserveFilesENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSPreserveFilesENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSPreserveFilesENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<PreserveFiles, std::true_type>
    >,
    nullptr
} };
...
void *PreserveFiles::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSPreserveFilesENDCLASS.stringdata0))
...
#ifdef QT_MOC_HAS_STRINGDATA
struct qt_meta_stringdata_CLASSPreserveFilesFactoryENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSPreserveFilesFactoryENDCLASS = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_CLASSPreserveFilesFactoryENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject PreserveFilesFactory::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSPreserveFilesFactoryENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSPreserveFilesFactoryENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSPreserveFilesFactoryENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<PreserveFilesFactory, std::true_type>
    >,
    nullptr
} };
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_CLASSPreserveFilesFactoryENDCLASS.stringdata0))
        return static_cast<void*>(this);
