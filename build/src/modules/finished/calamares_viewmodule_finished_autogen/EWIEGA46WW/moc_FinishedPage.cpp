...
struct qt_meta_stringdata_CLASSFinishedPageENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSFinishedPageENDCLASS = QtMocHelpers::stringData(
    "FinishedPage",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSFinishedPageENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject FinishedPage::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSFinishedPageENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSFinishedPageENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSFinishedPageENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<FinishedPage, std::true_type>,
...
void *FinishedPage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSFinishedPageENDCLASS.stringdata0))
