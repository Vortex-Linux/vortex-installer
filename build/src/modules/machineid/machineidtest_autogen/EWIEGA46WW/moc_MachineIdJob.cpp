...
struct qt_meta_stringdata_CLASSMachineIdJobENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSMachineIdJobENDCLASS = QtMocHelpers::stringData(
    "MachineIdJob"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSMachineIdJobENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject MachineIdJob::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSMachineIdJobENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSMachineIdJobENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSMachineIdJobENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *MachineIdJob::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSMachineIdJobENDCLASS.stringdata0))
...
#ifdef QT_MOC_HAS_STRINGDATA
struct qt_meta_stringdata_CLASSMachineIdJobFactoryENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSMachineIdJobFactoryENDCLASS = QtMocHelpers::stringData(
    "MachineIdJobFactory"
);
#else  // !QT_MOC_HAS_STRINGDATA
#error "qtmochelpers.h not found or too old."
...
Q_CONSTINIT static const uint qt_meta_data_CLASSMachineIdJobFactoryENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject MachineIdJobFactory::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSMachineIdJobFactoryENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSMachineIdJobFactoryENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSMachineIdJobFactoryENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_CLASSMachineIdJobFactoryENDCLASS.stringdata0))
        return static_cast<void*>(this);
