...
struct qt_meta_stringdata_CLASSInitcpioJobENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSInitcpioJobENDCLASS = QtMocHelpers::stringData(
    "InitcpioJob"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSInitcpioJobENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject InitcpioJob::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSInitcpioJobENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSInitcpioJobENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSInitcpioJobENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *InitcpioJob::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSInitcpioJobENDCLASS.stringdata0))
...
#ifdef QT_MOC_HAS_STRINGDATA
struct qt_meta_stringdata_CLASSInitcpioJobFactoryENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSInitcpioJobFactoryENDCLASS = QtMocHelpers::stringData(
    "InitcpioJobFactory"
);
#else  // !QT_MOC_HAS_STRINGDATA
#error "qtmochelpers.h not found or too old."
...
Q_CONSTINIT static const uint qt_meta_data_CLASSInitcpioJobFactoryENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject InitcpioJobFactory::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSInitcpioJobFactoryENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSInitcpioJobFactoryENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSInitcpioJobFactoryENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_CLASSInitcpioJobFactoryENDCLASS.stringdata0))
        return static_cast<void*>(this);
