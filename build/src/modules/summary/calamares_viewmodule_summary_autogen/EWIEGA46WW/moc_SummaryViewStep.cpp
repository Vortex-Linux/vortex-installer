...
struct qt_meta_stringdata_CLASSSummaryViewStepENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSSummaryViewStepENDCLASS = QtMocHelpers::stringData(
    "SummaryViewStep"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSSummaryViewStepENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject SummaryViewStep::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSSummaryViewStepENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSSummaryViewStepENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSSummaryViewStepENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *SummaryViewStep::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSSummaryViewStepENDCLASS.stringdata0))
...
#ifdef QT_MOC_HAS_STRINGDATA
struct qt_meta_stringdata_CLASSSummaryViewStepFactoryENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSSummaryViewStepFactoryENDCLASS = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_CLASSSummaryViewStepFactoryENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject SummaryViewStepFactory::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSSummaryViewStepFactoryENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSSummaryViewStepFactoryENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSSummaryViewStepFactoryENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_CLASSSummaryViewStepFactoryENDCLASS.stringdata0))
        return static_cast<void*>(this);
