...
struct qt_meta_stringdata_CLASSRemoveUserJobENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSRemoveUserJobENDCLASS = QtMocHelpers::stringData(
    "RemoveUserJob"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSRemoveUserJobENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject RemoveUserJob::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSRemoveUserJobENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSRemoveUserJobENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSRemoveUserJobENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *RemoveUserJob::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSRemoveUserJobENDCLASS.stringdata0))
...
#ifdef QT_MOC_HAS_STRINGDATA
struct qt_meta_stringdata_CLASSRemoveUserJobFactoryENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSRemoveUserJobFactoryENDCLASS = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_CLASSRemoveUserJobFactoryENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject RemoveUserJobFactory::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSRemoveUserJobFactoryENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSRemoveUserJobFactoryENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSRemoveUserJobFactoryENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_CLASSRemoveUserJobFactoryENDCLASS.stringdata0))
        return static_cast<void*>(this);
