...
struct qt_meta_stringdata_CLASSSetPasswordJobENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSSetPasswordJobENDCLASS = QtMocHelpers::stringData(
    "SetPasswordJob"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSSetPasswordJobENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject SetPasswordJob::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSSetPasswordJobENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSSetPasswordJobENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSSetPasswordJobENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<SetPasswordJob, std::true_type>
    >,
    nullptr
} };
...
void *SetPasswordJob::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSSetPasswordJobENDCLASS.stringdata0))
