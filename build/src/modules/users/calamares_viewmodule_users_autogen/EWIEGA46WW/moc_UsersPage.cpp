...
struct qt_meta_stringdata_CLASSUsersPageENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSUsersPageENDCLASS = QtMocHelpers::stringData(
    "UsersPage",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSUsersPageENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject UsersPage::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSUsersPageENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSUsersPageENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSUsersPageENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *UsersPage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSUsersPageENDCLASS.stringdata0))
