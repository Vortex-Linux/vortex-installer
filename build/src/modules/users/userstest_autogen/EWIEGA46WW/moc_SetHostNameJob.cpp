...
struct qt_meta_stringdata_CLASSSetHostNameJobENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSSetHostNameJobENDCLASS = QtMocHelpers::stringData(
    "SetHostNameJob"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSSetHostNameJobENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject SetHostNameJob::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSSetHostNameJobENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSSetHostNameJobENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSSetHostNameJobENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *SetHostNameJob::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSSetHostNameJobENDCLASS.stringdata0))
