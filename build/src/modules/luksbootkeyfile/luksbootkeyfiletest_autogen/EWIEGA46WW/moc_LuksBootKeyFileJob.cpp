...
struct qt_meta_stringdata_CLASSLuksBootKeyFileJobENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSLuksBootKeyFileJobENDCLASS = QtMocHelpers::stringData(
    "LuksBootKeyFileJob"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSLuksBootKeyFileJobENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject LuksBootKeyFileJob::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSLuksBootKeyFileJobENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSLuksBootKeyFileJobENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSLuksBootKeyFileJobENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *LuksBootKeyFileJob::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSLuksBootKeyFileJobENDCLASS.stringdata0))
...
#ifdef QT_MOC_HAS_STRINGDATA
struct qt_meta_stringdata_CLASSLuksBootKeyFileJobFactoryENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSLuksBootKeyFileJobFactoryENDCLASS = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_CLASSLuksBootKeyFileJobFactoryENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject LuksBootKeyFileJobFactory::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSLuksBootKeyFileJobFactoryENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSLuksBootKeyFileJobFactoryENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSLuksBootKeyFileJobFactoryENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_CLASSLuksBootKeyFileJobFactoryENDCLASS.stringdata0))
        return static_cast<void*>(this);
