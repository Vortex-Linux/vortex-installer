...
struct qt_meta_stringdata_CLASSCheckerContainerENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSCheckerContainerENDCLASS = QtMocHelpers::stringData(
    "CheckerContainer",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSCheckerContainerENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject CheckerContainer::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSCheckerContainerENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSCheckerContainerENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSCheckerContainerENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<CheckerContainer, std::true_type>,
...
void *CheckerContainer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSCheckerContainerENDCLASS.stringdata0))
