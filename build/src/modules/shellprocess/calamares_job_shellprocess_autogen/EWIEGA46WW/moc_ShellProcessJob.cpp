...
struct qt_meta_stringdata_CLASSShellProcessJobENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSShellProcessJobENDCLASS = QtMocHelpers::stringData(
    "ShellProcessJob"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSShellProcessJobENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject ShellProcessJob::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSShellProcessJobENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSShellProcessJobENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSShellProcessJobENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *ShellProcessJob::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSShellProcessJobENDCLASS.stringdata0))
...
#ifdef QT_MOC_HAS_STRINGDATA
struct qt_meta_stringdata_CLASSShellProcessJobFactoryENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSShellProcessJobFactoryENDCLASS = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_CLASSShellProcessJobFactoryENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject ShellProcessJobFactory::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSShellProcessJobFactoryENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSShellProcessJobFactoryENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSShellProcessJobFactoryENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_CLASSShellProcessJobFactoryENDCLASS.stringdata0))
        return static_cast<void*>(this);
