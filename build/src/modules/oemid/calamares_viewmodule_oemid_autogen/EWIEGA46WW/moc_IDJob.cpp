...
struct qt_meta_stringdata_CLASSIDJobENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSIDJobENDCLASS = QtMocHelpers::stringData(
    "IDJob"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSIDJobENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject IDJob::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSIDJobENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSIDJobENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSIDJobENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<IDJob, std::true_type>
    >,
    nullptr
} };
...
void *IDJob::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSIDJobENDCLASS.stringdata0))
