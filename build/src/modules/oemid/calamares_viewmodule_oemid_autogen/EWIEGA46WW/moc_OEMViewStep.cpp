...
struct qt_meta_stringdata_CLASSOEMViewStepENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSOEMViewStepENDCLASS = QtMocHelpers::stringData(
    "OEMViewStep"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSOEMViewStepENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject OEMViewStep::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSOEMViewStepENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSOEMViewStepENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSOEMViewStepENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<OEMViewStep, std::true_type>
    >,
    nullptr
} };
...
void *OEMViewStep::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSOEMViewStepENDCLASS.stringdata0))
...
#ifdef QT_MOC_HAS_STRINGDATA
struct qt_meta_stringdata_CLASSOEMViewStepFactoryENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSOEMViewStepFactoryENDCLASS = QtMocHelpers::stringData(
    "OEMViewStepFactory"
);
#else  // !QT_MOC_HAS_STRINGDATA
#error "qtmochelpers.h not found or too old."
...
Q_CONSTINIT static const uint qt_meta_data_CLASSOEMViewStepFactoryENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject OEMViewStepFactory::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSOEMViewStepFactoryENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSOEMViewStepFactoryENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSOEMViewStepFactoryENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<OEMViewStepFactory, std::true_type>
    >,
    nullptr
} };
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_CLASSOEMViewStepFactoryENDCLASS.stringdata0))
        return static_cast<void*>(this);
