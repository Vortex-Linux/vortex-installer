...
struct qt_meta_stringdata_CLASSSetKeyboardLayoutJobENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSSetKeyboardLayoutJobENDCLASS = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_CLASSSetKeyboardLayoutJobENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject SetKeyboardLayoutJob::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSSetKeyboardLayoutJobENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSSetKeyboardLayoutJobENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSSetKeyboardLayoutJobENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<SetKeyboardLayoutJob, std::true_type>
    >,
    nullptr
} };
...
void *SetKeyboardLayoutJob::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSSetKeyboardLayoutJobENDCLASS.stringdata0))
