...
struct qt_meta_stringdata_CLASSHostInfoJobENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSHostInfoJobENDCLASS = QtMocHelpers::stringData(
    "HostInfoJob"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSHostInfoJobENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject HostInfoJob::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSHostInfoJobENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSHostInfoJobENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSHostInfoJobENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *HostInfoJob::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSHostInfoJobENDCLASS.stringdata0))
...
#ifdef QT_MOC_HAS_STRINGDATA
struct qt_meta_stringdata_CLASSHostInfoJobFactoryENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSHostInfoJobFactoryENDCLASS = QtMocHelpers::stringData(
    "HostInfoJobFactory"
);
#else  // !QT_MOC_HAS_STRINGDATA
#error "qtmochelpers.h not found or too old."
...
Q_CONSTINIT static const uint qt_meta_data_CLASSHostInfoJobFactoryENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject HostInfoJobFactory::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSHostInfoJobFactoryENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSHostInfoJobFactoryENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSHostInfoJobFactoryENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_CLASSHostInfoJobFactoryENDCLASS.stringdata0))
        return static_cast<void*>(this);
