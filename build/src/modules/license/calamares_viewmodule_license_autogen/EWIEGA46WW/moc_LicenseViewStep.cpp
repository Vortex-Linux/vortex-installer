...
struct qt_meta_stringdata_CLASSLicenseViewStepENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSLicenseViewStepENDCLASS = QtMocHelpers::stringData(
    "LicenseViewStep"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSLicenseViewStepENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject LicenseViewStep::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSLicenseViewStepENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSLicenseViewStepENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSLicenseViewStepENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *LicenseViewStep::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSLicenseViewStepENDCLASS.stringdata0))
...
#ifdef QT_MOC_HAS_STRINGDATA
struct qt_meta_stringdata_CLASSLicenseViewStepFactoryENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSLicenseViewStepFactoryENDCLASS = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_CLASSLicenseViewStepFactoryENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject LicenseViewStepFactory::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSLicenseViewStepFactoryENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSLicenseViewStepFactoryENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSLicenseViewStepFactoryENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_CLASSLicenseViewStepFactoryENDCLASS.stringdata0))
        return static_cast<void*>(this);
