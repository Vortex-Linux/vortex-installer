...
struct qt_meta_stringdata_CLASSDummyCppJobENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSDummyCppJobENDCLASS = QtMocHelpers::stringData(
    "DummyCppJob"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSDummyCppJobENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject DummyCppJob::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSDummyCppJobENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSDummyCppJobENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSDummyCppJobENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<DummyCppJob, std::true_type>
    >,
    nullptr
} };
...
void *DummyCppJob::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSDummyCppJobENDCLASS.stringdata0))
...
#ifdef QT_MOC_HAS_STRINGDATA
struct qt_meta_stringdata_CLASSDummyCppJobFactoryENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSDummyCppJobFactoryENDCLASS = QtMocHelpers::stringData(
    "DummyCppJobFactory"
);
#else  // !QT_MOC_HAS_STRINGDATA
#error "qtmochelpers.h not found or too old."
...
Q_CONSTINIT static const uint qt_meta_data_CLASSDummyCppJobFactoryENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject DummyCppJobFactory::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSDummyCppJobFactoryENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSDummyCppJobFactoryENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSDummyCppJobFactoryENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<DummyCppJobFactory, std::true_type>
    >,
    nullptr
} };
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_CLASSDummyCppJobFactoryENDCLASS.stringdata0))
        return static_cast<void*>(this);
