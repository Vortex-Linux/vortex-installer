...
struct qt_meta_stringdata_CLASSZfsJobENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSZfsJobENDCLASS = QtMocHelpers::stringData(
    "ZfsJob"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSZfsJobENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject ZfsJob::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSZfsJobENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSZfsJobENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSZfsJobENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *ZfsJob::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSZfsJobENDCLASS.stringdata0))
...
#ifdef QT_MOC_HAS_STRINGDATA
struct qt_meta_stringdata_CLASSZfsJobFactoryENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSZfsJobFactoryENDCLASS = QtMocHelpers::stringData(
    "ZfsJobFactory"
);
#else  // !QT_MOC_HAS_STRINGDATA
#error "qtmochelpers.h not found or too old."
...
Q_CONSTINIT static const uint qt_meta_data_CLASSZfsJobFactoryENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject ZfsJobFactory::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSZfsJobFactoryENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSZfsJobFactoryENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSZfsJobFactoryENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_CLASSZfsJobFactoryENDCLASS.stringdata0))
        return static_cast<void*>(this);
