...
src/modules/tracking/libcalamares_viewmodule_tracking.so: /usr/lib/libQt6QmlModels.so.6.7.2
src/modules/tracking/libcalamares_viewmodule_tracking.so: /usr/lib/libQt6Qml.so.6.7.2
src/modules/tracking/libcalamares_viewmodule_tracking.so: /usr/lib/libQt6QmlBuiltins.a
src/modules/tracking/libcalamares_viewmodule_tracking.so: /usr/lib/libQt6Network.so.6.7.2
src/modules/tracking/libcalamares_viewmodule_tracking.so: /usr/lib/libQt6OpenGL.so.6.7.2
src/modules/tracking/libcalamares_viewmodule_tracking.so: /usr/lib/libQt6Widgets.so.6.7.2
src/modules/tracking/libcalamares_viewmodule_tracking.so: /usr/lib/libQt6Gui.so.6.7.2
src/modules/tracking/libcalamares_viewmodule_tracking.so: /usr/lib/libQt6Core.so.6.7.2
