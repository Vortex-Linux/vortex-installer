...
struct qt_meta_stringdata_CLASSTrackingStyleConfigENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSTrackingStyleConfigENDCLASS = QtMocHelpers::stringData(
    "TrackingStyleConfig",
    "trackingChanged",
    "",
    "policyChanged",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSTrackingStyleConfigENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject TrackingStyleConfig::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSTrackingStyleConfigENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSTrackingStyleConfigENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSTrackingStyleConfigENDCLASS_t,
...
void TrackingStyleConfig::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &TrackingStyleConfig::trackingChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &TrackingStyleConfig::policyChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
void *TrackingStyleConfig::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSTrackingStyleConfigENDCLASS.stringdata0))
...
void Config::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &Config::generalPolicyChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
