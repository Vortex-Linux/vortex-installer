...
struct qt_meta_stringdata_CLASSTrackingViewStepENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSTrackingViewStepENDCLASS = QtMocHelpers::stringData(
    "TrackingViewStep"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSTrackingViewStepENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject TrackingViewStep::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSTrackingViewStepENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSTrackingViewStepENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSTrackingViewStepENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *TrackingViewStep::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSTrackingViewStepENDCLASS.stringdata0))
...
#ifdef QT_MOC_HAS_STRINGDATA
struct qt_meta_stringdata_CLASSTrackingViewStepFactoryENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSTrackingViewStepFactoryENDCLASS = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_CLASSTrackingViewStepFactoryENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject TrackingViewStepFactory::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSTrackingViewStepFactoryENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSTrackingViewStepFactoryENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSTrackingViewStepFactoryENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_CLASSTrackingViewStepFactoryENDCLASS.stringdata0))
        return static_cast<void*>(this);
