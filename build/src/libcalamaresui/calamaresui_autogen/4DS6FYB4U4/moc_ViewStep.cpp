...
struct qt_meta_stringdata_CLASSCalamaresSCOPEViewStepENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSCalamaresSCOPEViewStepENDCLASS = QtMocHelpers::stringData(
    "Calamares::ViewStep",
    "nextStatusChanged",
    "",
    "status",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSCalamaresSCOPEViewStepENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject Calamares::ViewStep::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSCalamaresSCOPEViewStepENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSCalamaresSCOPEViewStepENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSCalamaresSCOPEViewStepENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<ViewStep, std::true_type>,
...
void Calamares::ViewStep::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &ViewStep::nextStatusChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &ViewStep::ensureSize; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
void *Calamares::ViewStep::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSCalamaresSCOPEViewStepENDCLASS.stringdata0))
