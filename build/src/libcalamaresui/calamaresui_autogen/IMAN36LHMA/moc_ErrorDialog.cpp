...
struct qt_meta_stringdata_CLASSCalamaresSCOPEErrorDialogENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSCalamaresSCOPEErrorDialogENDCLASS = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_CLASSCalamaresSCOPEErrorDialogENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject Calamares::ErrorDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSCalamaresSCOPEErrorDialogENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSCalamaresSCOPEErrorDialogENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSCalamaresSCOPEErrorDialogENDCLASS_t,
        // property 'heading'
...
void Calamares::ErrorDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &ErrorDialog::headingChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ErrorDialog::*)();
            if (_t _q_method = &ErrorDialog::informativeTextChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (ErrorDialog::*)();
            if (_t _q_method = &ErrorDialog::detailsChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (ErrorDialog::*)();
            if (_t _q_method = &ErrorDialog::shouldOfferWebPasteChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }
...
void *Calamares::ErrorDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSCalamaresSCOPEErrorDialogENDCLASS.stringdata0))
