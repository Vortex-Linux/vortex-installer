...
struct qt_meta_stringdata_CLASSCalamaresSCOPELogThreadENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSCalamaresSCOPELogThreadENDCLASS = QtMocHelpers::stringData(
    "Calamares::LogThread",
    "onLogChunk",
    "",
    "logChunk"
...
Q_CONSTINIT static const uint qt_meta_data_CLASSCalamaresSCOPELogThreadENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject Calamares::LogThread::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSCalamaresSCOPELogThreadENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSCalamaresSCOPELogThreadENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSCalamaresSCOPELogThreadENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void Calamares::LogThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &LogThread::onLogChunk; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *Calamares::LogThread::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSCalamaresSCOPELogThreadENDCLASS.stringdata0))
...
#ifdef QT_MOC_HAS_STRINGDATA
struct qt_meta_stringdata_CLASSCalamaresSCOPELogWidgetENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSCalamaresSCOPELogWidgetENDCLASS = QtMocHelpers::stringData(
    "Calamares::LogWidget",
    "handleLogChunk",
    "",
    "logChunk",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSCalamaresSCOPELogWidgetENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject Calamares::LogWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSCalamaresSCOPELogWidgetENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSCalamaresSCOPELogWidgetENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSCalamaresSCOPELogWidgetENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_CLASSCalamaresSCOPELogWidgetENDCLASS.stringdata0))
        return static_cast<void*>(this);
