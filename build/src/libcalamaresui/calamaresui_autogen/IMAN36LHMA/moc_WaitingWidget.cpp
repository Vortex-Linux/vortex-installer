...
struct qt_meta_stringdata_CLASSCountdownWaitingWidgetENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSCountdownWaitingWidgetENDCLASS = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_CLASSCountdownWaitingWidgetENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject CountdownWaitingWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSCountdownWaitingWidgetENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSCountdownWaitingWidgetENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSCountdownWaitingWidgetENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void CountdownWaitingWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (CountdownWaitingWidget::*)();
            if (_t _q_method = &CountdownWaitingWidget::timeout; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *CountdownWaitingWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSCountdownWaitingWidgetENDCLASS.stringdata0))
