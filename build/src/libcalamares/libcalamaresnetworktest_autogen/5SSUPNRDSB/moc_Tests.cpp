...
struct qt_meta_stringdata_CLASSNetworkTestsENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSNetworkTestsENDCLASS = QtMocHelpers::stringData(
    "NetworkTests",
    "initTestCase",
    "",
    "testInstance",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSNetworkTestsENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject NetworkTests::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSNetworkTestsENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSNetworkTestsENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSNetworkTestsENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<NetworkTests, std::true_type>,
        // method 'initTestCase'
...
void *NetworkTests::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSNetworkTestsENDCLASS.stringdata0))
