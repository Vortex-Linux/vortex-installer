...
struct qt_meta_stringdata_CLASSCalamaresSCOPERequirementsModelENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSCalamaresSCOPERequirementsModelENDCLASS = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_CLASSCalamaresSCOPERequirementsModelENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject Calamares::RequirementsModel::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSCalamaresSCOPERequirementsModelENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSCalamaresSCOPERequirementsModelENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSCalamaresSCOPERequirementsModelENDCLASS_t,
...
void Calamares::RequirementsModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &RequirementsModel::satisfiedRequirementsChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (RequirementsModel::*)(bool );
            if (_t _q_method = &RequirementsModel::satisfiedMandatoryChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &RequirementsModel::progressMessageChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
void *Calamares::RequirementsModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSCalamaresSCOPERequirementsModelENDCLASS.stringdata0))
