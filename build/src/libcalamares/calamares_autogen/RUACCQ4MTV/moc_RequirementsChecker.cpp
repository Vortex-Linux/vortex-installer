...
struct qt_meta_stringdata_CLASSCalamaresSCOPERequirementsCheckerENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSCalamaresSCOPERequirementsCheckerENDCLASS = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_CLASSCalamaresSCOPERequirementsCheckerENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject Calamares::RequirementsChecker::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSCalamaresSCOPERequirementsCheckerENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSCalamaresSCOPERequirementsCheckerENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSCalamaresSCOPERequirementsCheckerENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<RequirementsChecker, std::true_type>,
        // method 'requirementsProgress'
...
void Calamares::RequirementsChecker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &RequirementsChecker::requirementsProgress; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &RequirementsChecker::done; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
void *Calamares::RequirementsChecker::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSCalamaresSCOPERequirementsCheckerENDCLASS.stringdata0))
