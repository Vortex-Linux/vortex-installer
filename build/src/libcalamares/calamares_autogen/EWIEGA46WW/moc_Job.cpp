...
struct qt_meta_stringdata_CLASSCalamaresSCOPEJobENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSCalamaresSCOPEJobENDCLASS = QtMocHelpers::stringData(
    "Calamares::Job",
    "progress",
    "",
    "percent"
...
Q_CONSTINIT static const uint qt_meta_data_CLASSCalamaresSCOPEJobENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject Calamares::Job::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSCalamaresSCOPEJobENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSCalamaresSCOPEJobENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSCalamaresSCOPEJobENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void Calamares::Job::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &Job::progress; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *Calamares::Job::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSCalamaresSCOPEJobENDCLASS.stringdata0))
