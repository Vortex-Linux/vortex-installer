...
struct qt_meta_stringdata_CLASSGeoIPTestsENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSGeoIPTestsENDCLASS = QtMocHelpers::stringData(
    "GeoIPTests",
    "initTestCase",
    "",
    "testFixed",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSGeoIPTestsENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject GeoIPTests::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSGeoIPTestsENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSGeoIPTestsENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSGeoIPTestsENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<GeoIPTests, std::true_type>,
        // method 'initTestCase'
...
void *GeoIPTests::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSGeoIPTestsENDCLASS.stringdata0))
