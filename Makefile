#############################################################################
# Makefile for building: build/vortex-installer
# Generated by qmake (3.1) (Qt 5.15.15)
# Project:  vortex-installer.pro
# Template: app
# Command: /sbin/qmake -o Makefile vortex-installer.pro
#############################################################################
...
Makefile: vortex-installer.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/qt/mkspecs/features/yacc.prf \
		/usr/lib/qt/mkspecs/features/lex.prf \
		vortex-installer.pro \
		resources/styles.qrc \
		resources/images.qrc
	$(QMAKE) -o Makefile vortex-installer.pro
...
all: Makefile build/vortex-installer
